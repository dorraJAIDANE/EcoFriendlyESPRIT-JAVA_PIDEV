...
public class user {
    ...
    private double walletuser ;
    private String classeuser ;
    private String roleuser ;
    
    public user( String nomuser, String prenomuser, String mailuser, String mdpuser, String adressuser, double walletuser, String classeuser, String roleuser) {
    ...
    public double getWalletuser() {
        return walletuser;
    }

    public void setWalletuser(double walletuser) {
        this.walletuser = walletuser;
    }
